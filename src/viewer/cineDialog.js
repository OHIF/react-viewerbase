    ...
    render() {
        ...
        return (
            <div id="cineDialog">
                <h5>Cine Controls</h5>
                <div id="cineButtons">
                    <button id="cineFirstButton" title="Skip to first image" className="cineButton" data-toggle="tooltip">
                        <i className="fa fa-lg fa-fast-backward"></i>
                    </button>
                    <button id="cineBackButton" title="Previous image" className="cineButton" data-toggle="tooltip">
                        <i className="fa fa-lg fa-step-backward"></i>
                    </button>
                    <button id="cineSlowPlaybackButton" title="Slow playback" className="cineButton" data-toggle="tooltip">
                        <i className="fa fa-lg fa-backward"></i>
                    </button>
                    <button id="cinePlayButton" title="Play / Pause" className="cineButton" data-toggle="tooltip">
                        <i className="fa fa-lg {playClass}"></i>
                    </button>
                    <button id="cineFastForwardButton" title="Increase playback speed" className="cineButton"
                       data-toggle="tooltip">
                        <i className="fa fa-lg fa-forward"></i>
                    </button>
                    <button id="cineNextButton" title="Next image" className="cineButton" data-toggle="tooltip">
                        <i className="fa fa-lg fa-step-forward"></i>
                    </button>
                    <button id="cineLastButton" title="Skip to last image" className="cineButton" data-toggle="tooltip">
